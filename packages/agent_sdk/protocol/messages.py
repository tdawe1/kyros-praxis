...
class Artifact(BaseModel):
    ...
    kind: str = Field(..., description="Type of artifact (e.g., 'code', 'document', 'data')")
...
class AgentMessage(BaseModel):
    ...
    rationale_summary: str = Field(..., description="Summary of reasoning (no raw chain-of-thought)")
    ...
    agent_id: Optional[str] = Field(None, description="ID of the agent that created this message")
    task_id: Optional[str] = Field(None, description="ID of the task this message relates to")