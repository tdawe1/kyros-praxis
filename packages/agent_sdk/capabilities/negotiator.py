...
class CapabilityNegotiator:
    ...
    def register_agent(self, agent: AgentBase, capabilities: List[str], priority: int = 1):
    ...
    def match(self, task: Dict[str, Any], agents: Optional[List[AgentBase]] = None) -> Tuple[Optional[AgentBase], List[str]]:
        """
        ...
        for agent in candidate_agents:
            ...
            score, missing = self._calculate_match_score(requirements, agent_capabilities, agent_cap)
    ...
    def _calculate_match_score(self, requirements: TaskRequirements, 
                             agent_capabilities: List[str], 
                             agent_cap: Optional[AgentCapability]) -> Tuple[float, List[str]]:
