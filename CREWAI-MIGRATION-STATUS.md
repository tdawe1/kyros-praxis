...
The Kyros Praxis project has successfully implemented a **CrewAI-ready architecture** in `apps/api` while maintaining the legacy orchestrator for backward compatibility. This document tracks the migration progress and configuration changes.
...
**Files Modified**:
- `apps/console/app/page.tsx` - Changed default API_BASE to `http://localhost:8001`
- `apps/api/README.md` - Updated uvicorn command to use port 8001
- `apps/console/README.md` - Updated setup instructions with port 8001
...
**Console Documentation** (`apps/console/README.md`):
...
│  ━━━━━━━━━━━━━━━━━━━━━━━━━━         ━━━━━━━━━━━━━━          │
│                                                               │
│  apps/console (3000)    ────────┐    services/console       │
│         │                       │    (references legacy)     │
│         │ SSE                   │                            │
│         ↓                       │    kyros-praxis/services/  │
│  apps/api (8001)                │    orchestrator (8000)     │
│    ├── CrewAI                   │    ├── Job/Task API       │
│    ├── Manifests                │    ├── JWT Auth           │
...
**Documentation**:
- [apps/api/AUTH_API.md](apps/api/AUTH_API.md) - Complete API docs
...
### CrewAI API
- **Unit Tests**: Exist (`apps/api/tests/`)
...
2. **Duplicate Consoles**: Two console implementations exist
   - `apps/console` - New CrewAI-focused
...
- **Console Docs**: [apps/console/README.md](apps/console/README.md)
